...
public class Vehicle_1_19_4 implements Vehicle {
    ...
    public Vehicle_1_19_4(UUID seat, List<UUID> armorStands, Vector forwards, Location origin, String name, List<UUID> extraSeats, VehicleType vehicleType, UUID owner, UUID vehicleId) {
        this.id = vehicleId;
